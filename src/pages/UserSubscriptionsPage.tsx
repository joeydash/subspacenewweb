...
import { ArrowLeft, Package, Clock, Users, Share2, Settings, Star, ListFilter as Filter, Search, RefreshCw } from 'lucide-react';
      ...
      {isLoading ? (
        ...
        <div className="bg-dark-500 rounded-xl p-12 text-center">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Link to="/trending-subscriptions" className="btn btn-primary">
