...
import { ArrowLeft, Search, Users, Star, Clock, MessageSquare, Shield, Crown, Calendar, Award, Info, X } from 'lucide-react';
import { useAuthStore } from '../store/authStore';
import { useLanguageStore } from '../store/languageStore';
import { GroupsPageSkeleton } from '../skeletons/GroupsPageSkeleton';
...
const GroupsPage = () => {
  ...
  const handleJoinGroup = (group: GroupMember) => {
    ...
    if (group.room_id) {
      ...
      navigate(`/checkout/${group.room_id}`, { 
        state: { 
          groupDetails: groupInfo,
          groupMembers: [] // This will be fetched in the checkout page
        } 
      });
    }
  };
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            {planDetails?.service_image_url && (
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-lg overflow-hidden bg-white p-1.5 md:p-2 flex-shrink-0">
                <img
          ...
          {filteredAndSortedGroups?.map((group) => {
            ...
            const pricePerUser = Math.ceil(group.price / group.share_limit);
              ...
              <div
                ...
                className={`group bg-slate-800/60 backdrop-blur-sm rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 border border-slate-700/50 hover:border-slate-600 ${
                ...
                <div className="relative p-4 md:p-5 bg-gradient-to-br from-slate-800/50 to-slate-900/80">
                  <div className="flex items-center gap-3">
                    <div className="relative flex-shrink-0">
                     <div className="h-14 w-14 md:h-16 md:w-16 rounded-lg overflow-hidden bg-slate-700/30 shadow-lg ring-1 ring-slate-600/50 group-hover:ring-slate-500 transition-all duration-300">
                          <img
                ...
                <div className="p-4 md:p-5 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`flex-1 py-2.5 md:py-3 rounded-lg text-sm md:text-base font-medium transition-all duration-200 shadow-md hover:shadow-lg active:scale-[0.98] ${
                        isAvailable
