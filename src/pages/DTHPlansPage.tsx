...
import { ArrowLeft, Tv, Clock, Zap, Star, CheckCircle, AlertCircle } from 'lucide-react';
        ...
        {plans.length === 0 ? (
          ...
          <div className="space-y-3">
            {filteredPlans.map((plan) => (
              <div
                key={plan.id}
                className={`bg-dark-500 rounded-lg border transition-all duration-200 cursor-pointer ${
