		...
		return (
			<>
				...
				>
					...
					<span className="text-white font-medium text-sm md:text-xs lg:text-sm">{currentLanguage?.nativeName}</span>
				...
				<div className="absolute top-full right-0 mt-2 bg-dark-500 border border-gray-700 rounded-lg shadow-lg z-50 min-w-[280px] max-w-sm">
					...
					<div className="p-3 border-b border-gray-700">
						<div className="relative">
							...
							/>
							<Globe className="absolute left-2.5 top-1/2 transform -translate-y-1/2 h-3 w-3 text-gray-400" />
						</div>
					</div>
