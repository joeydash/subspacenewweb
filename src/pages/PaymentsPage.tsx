...
import { ArrowLeft, ShoppingCart, ExternalLink, Smartphone, Info, X, Star, Users, Shield, DollarSign, Percent, AlertCircle, CheckCircle } from 'lucide-react';
        ...
        <div className="h-48 md:h-64 relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            <div className="flex items-end gap-6">
              <div className="w-20 h-20 md:w-24 md:h-24 rounded-xl overflow-hidden flex-shrink-0 bg-white p-2 shadow-lg">
                <img
