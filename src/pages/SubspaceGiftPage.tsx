...
import { ArrowLeft, Gift, CheckCircle, Star, Trophy, Coins, Calendar, Award, Info, ExternalLink } from 'lucide-react';
    ...
    return (
      <div className="page-container pt-24">
        <div className="flex items-center gap-4 mb-8">
          <Link to="/subspace-gifts" className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-dark-400 rounded-lg">
        ...
        <div className="bg-dark-500 rounded-xl p-12 text-center">
          ...
          <Link to="/subspace-gifts" className="btn btn-primary">
            Back to Gifts
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="page-container pt-24">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="flex-shrink-0">
            {giftDetail.win_image ? (
              <div className="w-32 h-32 rounded-2xl overflow-hidden bg-white/10 p-4">
                <img
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-700">
              ...
              <span className={`font-medium ${
                giftDetail.is_claimed ? 'text-green-400' : 'text-orange-400'
              }`}>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Link to="/subspace-gifts" className="btn btn-secondary flex-1">
        ...
        <Link to="/coin-transactions" className="btn btn-secondary">
...
export default SubspaceGiftPage;