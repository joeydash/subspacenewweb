					...
					<div className="flex-1 text-center lg:text-left w-full">
						<div className="flex items-center justify-between mb-4 sm:mb-6">
							<div className="flex items-center gap-2 sm:gap-4 min-w-0">
								<div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full overflow-hidden bg-dark-400 border-2 border-indigo-500/30 flex-shrink-0">
									{user?.dp ? (
										<img
											src={user.dp}
						...
						<div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
							<Link to="/" className="btn btn-primary text-sm sm:text-base lg:text-lg px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3">
								<Zap className="h-4 w-4 sm:h-5 sm:w-5 mr-2" />
								{t('home.explore')}
							</Link>
							<Link to="/wallet" className="btn btn-secondary text-sm sm:text-base lg:text-lg px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3">
...
const DueAmountAlert = () => {
	...
	return (
		<div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/30 rounded-xl p-4 sm:p-6">
			<div className="flex items-center justify-between gap-3">
				...
				<Link to="/wallet" className="btn btn-primary text-sm sm:text-base px-3 sm:px-4 py-2 whitespace-nowrap flex-shrink-0">
					{t('home.payNow')}
				</Link>
			</div>
		</div>
		...
		<div className="flex-none w-80 bg-dark-500 rounded-xl p-6 hover:bg-dark-400 transition-all duration-300 border border-gray-700/50 hover:border-indigo-500/50 group">
			...
			<div className="space-y-3">
				...
				{subscription.room_id && (
					<Link
						to={`/chat?groupId=${subscription.room_id}`}
		...
		<>
			<section>
				<div className="flex items-center justify-between gap-3 mb-6">
					...
					<Link to="/user-subscriptions" className="text-indigo-400 hover:text-indigo-300 flex items-center gap-1 whitespace-nowrap text-sm sm:text-base flex-shrink-0">
						{t('common.viewAll')}
				...
				{isLoading ? (
					...
					<div className="bg-dark-500 rounded-xl p-12 text-center">
						...
						<Link to="/" className="w-[70%] mx-auto btn btn-primary">
	...
	return (
		...
		>
			<div className="flex flex-col items-center mb-4">
				<div className="w-16 h-16 mx-2 mb-1 rounded-lg overflow-hidden bg-transparent p-1 group-hover: transition-colors">
					<img
						src={option.icon}
						alt={option.name}
						className="w-full h-full object-contain"
	...
	return (
		<section>
			<div className="flex items-center justify-between gap-3 mb-6">
				...
				<Link to="/quick-payments" className="text-indigo-400 hover:text-indigo-300 flex items-center gap-1 whitespace-nowrap text-sm sm:text-base flex-shrink-0">
					{t('common.viewAll')}
					<ChevronRight className="h-4 w-4" />
				</Link>
			</div>
...
const QuickActionsSection = () => {
	...
	return (
		<section className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
			<Link to="/" className="bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 rounded-xl p-4 sm:p-6 hover:from-indigo-500/30 hover:to-purple-500/30 transition-all duration-300 group">
				<div className="flex items-center gap-3 sm:gap-4">
					<div className="w-10 h-10 sm:w-12 sm:h-12 bg-indigo-500/20 rounded-lg flex items-center justify-center group-hover:bg-indigo-500/30 transition-colors flex-shrink-0">
			...
			<Link to="/public-groups" className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-xl p-4 sm:p-6 hover:from-green-500/30 hover:to-emerald-500/30 transition-all duration-300 group">
				<div className="flex items-center gap-3 sm:gap-4">
			...
			<Link to="/profile" className="bg-gradient-to-br from-orange-500/20 to-red-500/20 border border-orange-500/30 rounded-xl p-4 sm:p-6 hover:from-orange-500/30 hover:to-red-500/30 transition-all duration-300 group">
				<div className="flex items-center gap-3 sm:gap-4">
					<div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-500/20 rounded-lg flex items-center justify-center group-hover:bg-orange-500/30 transition-colors flex-shrink-0">
...
const HomePage = () => {
	return (
		<div className="pt-16 min-h-screen bg-gradient-to-br from-dark-600 via-dark-700 to-dark-800">
			<HeaderSection />
