...
import { X, FileText, Info, Star, Phone, LogOut, Crown, ArrowLeft, ChevronRight, CreditCard as Edit, MessageSquare, Calendar, Mail, FileImage, Trash2, CreditCard, UserPlus, Link, EllipsisVertical } from 'lucide-react';
...
import ChatMailBox from './ChatMailBox';
import UploadTermsComponent from './UploadTermsComponent';
											...
											<div className="space-y-2 sm:space-y-3">
												...
												>
													<div className="w-5 h-5 sm:w-6 sm:h-6 bg-gray-500/20 rounded flex items-center justify-center">
														<svg className="h-3.5 w-3.5 sm:h-4 sm:h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
