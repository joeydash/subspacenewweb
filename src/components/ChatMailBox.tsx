...
import { ArrowLeft, Copy, CheckCircle, Play, Video, Shield, Users, MessageSquare } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 rounded-xl p-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="w-12 h-12 bg-purple-500/20 rounded-full flex items-center justify-center hover:bg-purple-500/30 transition-colors flex-shrink-0"
          >
