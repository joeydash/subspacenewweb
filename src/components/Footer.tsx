  ...
  const [showLogin, setShowLogin] = useState(false);
	...
	const handleSuggestionSubmit = async () => {
		...
		try {
          ...
          `,
			...
			console.log('add suggestin chat ', res);
	...
	return (
		<footer className="bg-black text-white py-8 sm:py-12">
			<div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-[2000px] mx-auto">
				...
				<div className="flex flex-col md:flex-row md:items-start justify-evenly gap-6 sm:gap-8">
					...
					<div className="flex-1 min-w-0 md:max-w-[220px]">
						<div className="flex items-center mb-2 sm:mb-3">
							<img src="/subspace-hor_002.svg" alt="Subspace" className="h-6 sm:h-8 w-auto" />
						</div>
					...
					{/* Legal */}
					<div className="flex-1 min-w-0 md:max-w-[160px]">
              ...
              <li>
								<a href='/blogs'  target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
									Blogs
								</a>
							</li>
						</ul>
					...
					<div className="flex-1 min-w-0 md:max-w-[300px]">
						...
						<div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-8">
							<a href={followLinks.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-80 transition-opacity">
								<img src="/linkedin.svg" alt="LinkedIn" className="h-5 w-5 sm:h-6 sm:w-6" />
							</a>
							...
							<a href={followLinks.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-80 transition-opacity">
								<img src="/facebook.svg" alt="Facebook" className="h-5 w-5 sm:h-6 sm:w-6" />
							</a>
							<a href={followLinks.x} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hover:opacity-80 transition-opacity">
								<img src="/x.svg" alt="X" className="h-5 w-5 sm:h-6 sm:w-6" />
							</a>
						</div>
            	...
            	<div className="flex-1 min-w-0">
                  ...
                  handleSuggestionSubmit()
								...
								className="flex-shrink-0 inline-flex items-center justify-center bg-indigo-500 hover:bg-indigo-600 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-2.5 sm:px-3 py-2 transition-colors duration-200 h-[40px] w-[40px] sm:h-[44px] sm:w-[44px] border-0"
							>
								{isSubmitting ? (
