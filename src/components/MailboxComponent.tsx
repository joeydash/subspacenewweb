...
import MailboxSkeleton from '../skeletons/MailboxSkeleton';
			...
			<div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 rounded-lg p-4">
				<div className="flex items-center justify-between gap-3">
					...
					<button
						...
						className="w-12 h-12 flex items-center justify-center bg-purple-500/20 rounded-full hover:bg-purple-500/30 transition-colors flex-shrink-0"
					>
						<Player
							autoplay
							loop
