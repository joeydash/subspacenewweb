    ...
    if (isPriceLoading && validPeriod) {
      return (
        <SkeletonTheme baseColor="#2a2a2a" highlightColor="#3a3a3a" duration={1.5}>
          <div className="bg-gradient-to-br from-dark-400 to-dark-500 rounded-lg p-4 border border-gray-700">
            <div className="mb-3">
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-4 mt-4 border-t border-gray-700">
            ...
            <button
              ...
              className={`flex-1 px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors text-sm sm:text-base ${
                isValidRentalPeriod() && !isPriceLoading && priceData
