				...
				{isLoading? (
                  ...
                  step={1}
						...
						<button
							...
							className={`w-full py-3 md:py-4 rounded-lg md:rounded-xl font-bold text-base md:text-lg transition-colors flex items-center justify-center gap-2 ${
								isAmountValid() && amount && !isWithdrawing
