  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-3 md:p-4">
      <div className="bg-dark-500 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto small-scrollbar shadow-2xl">
        ...
        <div className="sticky top-0 bg-gradient-to-br from-dark-500 to-dark-400 border-b border-gray-700/50 p-6 md:p-8 flex justify-between items-start backdrop-blur-lg">
            ...
            <div className="flex flex-wrap items-baseline gap-3">
              ...
              {plan.price > plan.discounted_price && (
                <>
                  ...
                  <span className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-sm px-3 py-1.5 rounded-full font-semibold">
          ...
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-white transition-colors flex-shrink-0 ml-4 hover:bg-dark-400 rounded-lg p-2"
          >
            <X className="h-6 w-6" />
          </button>
        </div>
