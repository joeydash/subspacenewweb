...
import { useLowestDiscountPlans } from '../hooks/plans/useLowestDiscountPlans';
...
const InfiniteScroller = () => {
  ...
  const navigate = useNavigate();
	...
	const renderMessage = (plan: any) => {
		...
		return (
			<button onClick={() => navigate('/products/' + plan.service_id)}>
	...
	if (isLoading || !plans || plans.length === 0) {
		return (
			<div className="w-full bg-gradient-to-r from-gray-800/90 to-gray-900/90 border-b border-gray-700/50">
...
return (
	<div
		className="w-full bg-gradient-to-r from-gray-800/90 to-gray-900/90 border-b border-gray-700/50"
