							...
							<div
								...
								<div className="flex items-center space-x-3 w-max px-1">
									<button
										...
										className={`flex-shrink-0 whitespace-nowrap px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${selectedCategory === 'All'
									...
									{categories.map((category) => (
										<button
											...
											className={`flex-shrink-0 whitespace-nowrap px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${selectedCategory === category.title
												? 'bg-indigo-500 text-white shadow-lg'
												: 'bg-dark-400 text-gray-400 hover:bg-dark-300 hover:text-white'
												}`}
										>
