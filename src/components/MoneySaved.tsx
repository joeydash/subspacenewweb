...
const MoneySaved: React.FC = () => {
	...
	return (
		<div className="space-y-8 pb-4">
			...
			<button
				onClick={handleShare}
				className="w-full py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform"
			>
